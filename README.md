...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/bamboo-8.2.svg)](https://hub.docker.com/r/alvistack/bamboo-8.2)
...
Start Atlassian Bamboo Server:
    ...
    # Pull latest image
    docker pull alvistack/bamboo-8.2
