...
[![Docker
Pulls](https://img.shields.io/docker/pulls/alvistack/bamboo-12.0.svg)](https://hub.docker.com/r/alvistack/bamboo-12.0)
...
- [`alvistack/bamboo-12.0`](https://hub.docker.com/r/alvistack/bamboo-12.0)
  - [`packer/docker-12.0/packer.json`](https://github.com/alvistack/docker-bamboo/blob/master/packer/docker-12.0/packer.json)
...
Start Atlassian Bamboo Server:
    ...
    # Pull latest image
    docker pull alvistack/bamboo-12.0
