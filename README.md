...
[![Docker
Pulls](https://img.shields.io/docker/pulls/alvistack/bamboo-9.6.svg)](https://hub.docker.com/r/alvistack/bamboo-9.6)
...
Start Atlassian Bamboo Server:
    ...
    # Pull latest image
    docker pull alvistack/bamboo-9.6
