...
[![Docker
Pulls](https://img.shields.io/docker/pulls/alvistack/bamboo-10.1.svg)](https://hub.docker.com/r/alvistack/bamboo-10.1)
...
- [`alvistack/bamboo-10.1`](https://hub.docker.com/r/alvistack/bamboo-10.1)
  - [`packer/docker-10.1/packer.json`](https://github.com/alvistack/docker-bamboo/blob/master/packer/docker-10.1/packer.json)
...
Start Atlassian Bamboo Server:
    ...
    # Pull latest image
    docker pull alvistack/bamboo-10.1
